  ...
  return (
    <CardBody
      className={`grid gap-5 ${
        isNotFavorite
          ...
          : "max-h-30 overflow-hidden flex items-center justify-center py-2 mt-1"
      }`}
      style={{
    ...
    >
      {isNotFavorite ? (
        ...
        <div className="flex flex-col items-center justify-start gap-2 w-full text-sm">
          {!!trainingData?.name && (
            <div className="flex items-center bg-zinc-800 py-2 px-1 rounded-md w-full justify-center">
